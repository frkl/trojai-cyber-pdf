...
class Detector(AbstractDetector):
    ...
    #Defines how to run a Trojan detector
    def infer(self,model_filepath,result_filepath,scratch_dirpath,examples_dirpath,round_training_dataset_dirpath=None):
